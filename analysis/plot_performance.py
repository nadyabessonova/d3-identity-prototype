...
os.environ.setdefault("MPLCONFIGDIR", "artifacts/cache/matplotlib")
...
OUTPUT_DIR = Path("artifacts/performance/plots/performance_plots")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate performance plots from D3 performance results."
    )
